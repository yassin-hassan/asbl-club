...
export const APIS = [AccountService, AssociationsService, AuditService, AuthenticationService, EventManagementService, PaymentSetupService, PublicService, RegistrationsService];
