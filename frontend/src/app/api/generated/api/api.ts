...
export const APIS = [AccountService, AssociationsService, AuthenticationService, EventManagementService, PaymentSetupService, PublicService, RegistrationsService];
